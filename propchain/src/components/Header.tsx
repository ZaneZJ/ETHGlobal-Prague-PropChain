    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-6 backdrop-blur-sm shadow-sm bg-white/60">
        ...
        <nav className="hidden md:flex gap-8 text-sm font-medium text-gray-700 uppercase" style={{ marginRight: '150px' }}>
          ...
          <a href="#" className="transition-colors duration-200 hover:text-yellow-600">Explore</a>
          <a href="#" className="transition-colors duration-200 hover:text-yellow-600">Contacts</a>
          <a href="#" className="transition-colors duration-200 hover:text-yellow-600">Access</a>
          <button
            type="button"
      ...
      <div className={`fixed top-0 right-0 w-64 h-full z-50 transition-transform duration-500 ${menuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="bg-black/90 flex flex-col items-start p-8 h-full relative">
          ...
          <a href="#" className="text-white mb-4 transition-all duration-400 hover:text-yellow-600 text-sm md:text-base tracking-[0.2em] font-medium uppercase" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            HOME
          </a>
          <a href="#" className="text-white mb-4 transition-all duration-400 hover:text-yellow-600 text-sm md:text-base tracking-[0.2em] font-medium uppercase" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            EXPLORE
